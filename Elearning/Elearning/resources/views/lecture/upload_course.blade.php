        ...
        <div class="row">
            <div class="col-md-3 ">
                <div class="list-group ">
                    ...
                    <a href="{{route('upload_course')}}" class="list-group-item list-group-item-action active">Thêm mới</a>
                            ...
                            <div class="col-md-12">
                                <form action="{{route('post_upload_course')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input name="course_id" placeholder="mã khóa học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input name="course_name" placeholder="tên khóa học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="subject_id" placeholder="mã môn học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="description" placeholder="Mô tả" class="form-control here" type="text" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="requirements" placeholder="Yêu cầu đối với môn học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="outcomes" placeholder="Kết quả đạt được sau môn học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="slug" placeholder="link môn học" class="form-control here" type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input  name="test" placeholder="link bài kiểm tra" class="form-control here" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email" class="col-4 col-form-label">Email</label>
                                        <div class="col-8">
                                            <input name="lecture_email" placeholder="" class="form-control here" value="<?php echo auth()->user()->email ?>" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
