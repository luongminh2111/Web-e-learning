...
@section('library_store')
    ...
    <div class="row">
        ...
        <div class="contents">
            <?php
            $data =DB::table('libraries')->where('subject_name','=','Hóa Học')->limit(3)->get();?>
            @foreach($data as $item)
                <div class="item">
                    <p class="titles">{{$item->title}}</p>
                    <p><i class="fas fa-folder-open"></i> {{$item->subject_name}} {{$item->grade}}</p>
    ...
    <div class="row">
        ...
        <div class="contents">
            <?php
            $data =DB::table('libraries')->where('subject_name','=','Tiếng anh')->limit(3)->get();?>
            @foreach($data as $item)
                <div class="item">
                    <p class="titles">{{$item->title}}</p>
                    <p><i class="fas fa-folder-open"></i> {{$item->subject_name}} {{$item->grade}}</p>
    ...
    <div class="row">
        ...
        <div class="contents">
            <?php
            $data =DB::table('libraries')->where('subject_name','=','Văn')->limit(3)->get();?>
            @foreach($data as $item)
                <div class="item">
                    <p class="titles">{{$item->title}}</p>
                    <p><i class="fas fa-folder-open"></i> {{$item->subject_name}} {{$item->grade}}</p>
