                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label for="id" class="col-4 col-form-label">Môn học</label>
                                    <div class="col-8">
                                        <p class="text-primary"> {{$result->subject_name}} </p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="question" class="col-4 col-form-label">Nội dung câu hỏi</label>
                                    <div class="col-8">
                                        <p class="text-danger"> {{$result->question}}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <p class="text-danger">{{$result->answer}}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
